...
import { Github, Linkedin, Mail as Gmail } from "lucide-react";
    ...
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 flex flex-col lg:gap-4">
      <div className="flex flex-col gap-4 lg:pr-24 mt-6 lg:mt-0">
        ...
        <p className="text-lg lg:text-start text-muted-foreground">
          Full-stack developer with hands-on experience building scalable web applications and automating data pipelines.
          Skilled in designing and deploying custom web scrapers to extract, process, and analyze data from complex, dynamic, highly secured sources.
        </p>
      </div>
      ...
      <ul className="flex flex-row gap-6 mt-6 lg:mt-0">
        <Button variant="outline" size="icon">
          <a
            href="https://github.com/ares0524"
            target="_blank"
        ...
        <Button variant="outline" size="icon">
          <a
            href="mailto:ilikepython7@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Gmail className="h-[1.2rem] w-[1.2rem]" />
          </a>
        </Button>
        <ModeToggle />
      </ul>
